 ...
 */
final class Version20191031110136 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fiche_frais (id INT AUTO_INCREMENT NOT NULL, visituer_id INT NOT NULL, etat_id INT NOT NULL, mois VARCHAR(10) NOT NULL, nb_justificatifs INT NOT NULL, montant_valide NUMERIC(10, 2) NOT NULL, date_modif DATE NOT NULL, INDEX IDX_5FC0A6A71C44A624 (visituer_id), INDEX IDX_5FC0A6A7D5E86FF (etat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE fiche_frais ADD CONSTRAINT FK_5FC0A6A71C44A624 FOREIGN KEY (visituer_id) REFERENCES visiteur (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fiche_frais DROP FOREIGN KEY FK_5FC0A6A71C44A624');
